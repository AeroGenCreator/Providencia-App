...
st.sidebar.subheader(f':blue[{l.phrase[60]}]')
...
st.Page(page='best_price.py', title=l.phrase[72], icon=':material/price_check:'),
st.Page(page='historial.py', title=l.phrase[4], icon=':material/history:'),
st.Page(page='reorden.py', title=l.phrase[114], icon=':material/local_shipping:'),
st.Page(page='estadisticas.py', title=l.phrase[5], icon=':material/analytics:'),
st.Page(page='generador_matriz_x.py', title=l.phrase[126], icon=':material/graph_2:'),
st.Page(page='machine_learning.py', title=l.phrase[118], icon=':material/neurology:'),
